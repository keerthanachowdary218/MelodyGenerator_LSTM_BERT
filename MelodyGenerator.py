...
from Preprocesscopy import SEQUENCE_LENGTH, MAPPING_PATH

class MelodyGenerator:
    """A class that wraps the LSTM model and offers utilities to generate melodies."""

    def __init__(self, model_path="/Users/keerthanagolla/Desktop/RICE/SEM-1/StatisticalML/MusicGenerator/PreprocessedErnDataset/model.h5"):
