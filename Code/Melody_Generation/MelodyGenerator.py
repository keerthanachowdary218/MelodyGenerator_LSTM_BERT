...
class MelodyGenerator:
    ...
    Change the model_path to where you wanted to save the model at"""
#/Users/keerthanagolla/Desktop/RICE/SEM-1/StatisticalML/MusicGenerator/PreprocessedErnDataset/model.h5
    def __init__(self, model_path="/Users/keerthanagolla/Desktop/RICE/SEM-1/StatisticalML/MusicGenerator/Code/model.h5"):
    ...
    def save_melody(self, melody, step_duration=0.25, format="midi", file_name="transformermel.midi"):
        ...
        :param file_name (str): Name of midi file- Change accordingly
        :return:
        """
...
if __name__ == "__main__":
    mg = MelodyGenerator()
    #You can give any seed below, and try generating the melody
